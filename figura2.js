  ...
  crearFiguras(){
   return [
      function(){
        ...
        this.graficoFigura.bezierVertex(0,0,80,80,10,290)
        ////////////LADO ABAJO-/////////////////
        this.graficoFigura.vertex(10,290); 
        this.graficoFigura.bezierVertex(10,290,10,260,300,300)
        ////////////LADO DERECHO-/////////////////
      ...
      function() {
        ...
        ////////////LADO IZQUIERDO-/////////////////
        this.graficoFigura.vertex(0, 0);
        this.graficoFigura.bezierVertex(0,0,20,10,0,300)
        ////////////LADO ABAJO-/////////////////
        this.graficoFigura.vertex(0,300); 
        this.graficoFigura.bezierVertex(0,300,230,200,260,300)
        ////////////LADO DERECHO-/////////////////
      ...
      function() {
        ...
        this.graficoFigura.bezierVertex(300,40,30,10,0,0)
        this.graficoFigura.vertex(0,0);
        this.graficoFigura.endShape();
      }
