  ...
  crearFiguras(){
   return [
      function(){
        ...
        this.graficoFigura.bezierVertex(0,300,230,290,250,300)
        ////////////LADO DERECHO-/////////////////
        this.graficoFigura.vertex(250,300);
        this.graficoFigura.bezierVertex(250,300,280,100,260,0)
        ////////////LADO ARRIBA-/////////////////
      ...
      function() {
        ...
        this.graficoFigura.vertex(0, 0);
        this.graficoFigura.bezierVertex(0,0,100,100,0,300)
        ////////////LADO ABAJO-/////////////////
        this.graficoFigura.vertex(0,300);
      ...
      function() {
        ...
        this.graficoFigura.vertex(0, 0);
        this.graficoFigura.bezierVertex(0,0,30,5,0,300)
        ////////////LADO ABAJO-/////////////////
        this.graficoFigura.vertex(0,300);
        this.graficoFigura.bezierVertex(0,300,210,290,300,300)
        ////////////LADO DERECHA-/////////////////
        this.graficoFigura.vertex(300,300);
        this.graficoFigura.bezierVertex(300,300,280,280,300,40)
        ////////////LADO ARRIBA-/////////////////
        this.graficoFigura.vertex(300,40);
        this.graficoFigura.bezierVertex(300,40,280,20,0,0)
        this.graficoFigura.vertex(0,0);
        this.graficoFigura.endShape();
      }
